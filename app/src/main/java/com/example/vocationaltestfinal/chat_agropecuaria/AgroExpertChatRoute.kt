...
@Composable
internal fun AgroExpertRoute(
    agroExpertViewModel : AgroExpertViewModel = viewModel(factory = GenerativeViewModelFactory),
) {
    val chatUiState by  agroExpertViewModel.uiState.collectAsState()
        ...
        bottomBar = {
            MessageInput(
                onSendMessage = { inputText ->
                    agroExpertViewModel.sendMessage(inputText)
                },
                resetScroll = {
